...
M[18] = M[18]+h*(A[18][0]+2*A[18][1]+2*A[18][2]+A[18][3])/6;
	...
	for(tt=0;tt<t_N;tt++)
        ...
        SD+=10*(fabs(pro_com[0]-lab_com[0])+fabs(pro_com[2]-lab_com[1])+fabs(pro_com[3]-lab_com[2])+fabs(pro_com[5]-lab_com[3]));                
		SD+=10*(fabs(pro_com1[0]-lab_com1[0])+fabs(pro_com1[2]-lab_com1[1])+fabs(pro_com1[3]-lab_com1[2])+fabs(pro_com1[5]-lab_com1[3]));        
        //sum of mRNA expression of pmrD promoter difference
		SD+=10*(fabs(pro_comd[0]-lab_mRNA[0])+fabs(pro_comd[2]-lab_mRNA[1])+fabs(pro_comd[3]-lab_mRNA[2])+fabs(pro_comd[5]-lab_mRNA[3])+fabs(pro_comd[7]-lab_mRNA[4])); 
        SD+=10*(fabs(pro_comd1[0]-lab_mRNA1[0])+fabs(pro_comd1[2]-lab_mRNA1[1])+fabs(pro_comd1[3]-lab_mRNA1[2])+fabs(pro_comd1[5]-lab_mRNA1[3])+fabs(pro_comd1[7]-lab_mRNA1[4])); 
